...
// SPAs (driver, worker/Masar). Masar retains its waiting-worker reload banner;
// driver security builds activate and reload automatically. The factory keeps
// both lifecycles explicit without duplicating registration wiring.
import { ref } from "vue";
