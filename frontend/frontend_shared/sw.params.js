...
export const SW_PARAMS = {
  driver_portal: {
    ...
    dataCacheHost: "driver-data",
    dataEndpoints: [
      "/api/method/apex.salis.api.driver_portal.get_driver_context",
      "/api/method/apex.salis.api.driver_portal.get_my_today",
      "/api/method/apex.salis.api.driver_portal.get_driver_profile",
      "/api/method/apex.salis.api.driver_portal.get_my_vehicle",
      "/api/method/apex.salis.api.driver_portal.my_trips_today",
      "/api/method/apex.salis.api.driver_portal.my_worker_route_today",
      "/api/method/apex.salis.api.driver_portal.my_trip_route",
    ],
