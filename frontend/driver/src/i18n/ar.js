...
export default {
  ...
  install: {
    body: "ثبّت مسار للوصول السريع بملء الشاشة.",
  ...
  boarding: {
    ...
    camera_unsupported: "هذا المتصفح ما يقدر يمسح. استخدم الصعود اليدوي.",
    camera_absent: "ما فيه كاميرا في هذا الجهاز. استخدم الصعود اليدوي.",
    camera_insecure: "المسح يحتاج اتصالاً آمناً (https). استخدم الصعود اليدوي.",
    camera_denied: "يلزم الوصول إلى الكاميرا للمسح. اسمح به في المتصفح، أو استخدم الصعود اليدوي.",
    camera_busy: "الكاميرا مشغولة ببرنامج آخر. أغلقه، أو استخدم الصعود اليدوي.",
    camera_failed: "الكاميرا ما اشتغلت. استخدم الصعود اليدوي.",
  ...
  errors: {
    ...
    linkDeadTitle: "هذا الرابط لم يعد يعمل",
