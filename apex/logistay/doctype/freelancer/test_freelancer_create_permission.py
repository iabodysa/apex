...
`_set_defaults` returns early under `frappe.flags.in_import` (document.py:833,
set by frappe/modules/import_file.py:212), so a key left out of a shipped
DocPerm row imports as 0. The runtime half of this proof lives in
