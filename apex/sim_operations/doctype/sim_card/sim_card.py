...
from apex.sim_operations.utils.normalize import normalize_iccid, normalize_msisdn
...
class SIMCard(Document):
    ...
    def _refresh_contract_counts(self):
        ...
        from apex.sim_operations.doctype.telecom_contract.telecom_contract import (
            refresh_sim_count,
        )
