...
(A-235). A mirror is a source-text guard wearing a behavioural costume: it asserted
...
def _legacy_fragment(filters, from_key="from_date", to_key="to_date"):
    ...
    Legitimately a frozen copy, unlike the report mirrors this module used to carry:
    it is the SPEC the extracted helper had to preserve, it is compared against the
