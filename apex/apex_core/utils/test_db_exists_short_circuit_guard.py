...
# The unproven remainder over the production tree (the test lane is out of scope --
# see the module docstring) that is neither a filter dict, nor "DocType", nor a
# static name distinct from its doctype -- pre-existing and unreviewed, NOT endorsed.
# Delete a row in the commit that converts its call to the dict form, and add one in
# the commit that introduces a new unproven call the reviewer accepts;
# test_baseline_holds_no_stale_entry and test_no_new_unproven_name_probe both insist.
_BASELINE: dict[str, str] = {
    ...
    "apex_core/setup/salis_support.py#configure_support_sla#Holiday List": "holiday_list",
    "apex_core/setup/salis_support.py#configure_support_sla#Issue Priority": "priority",
    "apex_core/setup/salis_support.py#ensure_support_holiday_list#Holiday List": "name",
    "apex_core/setup/salis_support.py#grant_issue_role_permissions#Role": "role",
    "apex_core/setup/seeders/module_profile_seed.py#seed_module_profiles#Module Profile": "profile_name",
    "apex_core/setup/seeders/portal_identity_seed.py#_ensure_role#Role": "role",
    "apex_core/setup/seeders/portal_identity_seed.py#seed_portal_identities#User": "email",
    "habitat/api/arrivals_desk.py#house_over_capacity#Room": "room",
    "habitat/api/front_desk.py#_has_active_assignment#Housing Assignment": "filters",
    "habitat/utils/room_generator.py#_apply_capacity_reductions#Bed": "_surplus_code",
    "habitat/utils/room_generator.py#_apply_capacity_reductions#Housing Assignment": "occupancy.active_assignment_filters(bed=_surplus_code)",
