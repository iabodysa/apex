...
Home: the unit under test is ``apex/setup.py``, whose directory is the app
...
def _roles_list():
    ...
    import apex.setup as setup_mod
...
class TestCreateRolesList(unittest.TestCase):
    ...
    # Fleet operational roles are provisioned via create_roles, not fixtures.
    FLEET_ROLES = [
        "Fleet Manager",
        "Driver",
    ]
