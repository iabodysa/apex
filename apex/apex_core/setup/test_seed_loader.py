...
"""Guards for the data-driven seed loader (apex.apex_core.setup.seed).
...
from apex.apex_core.setup.seed import DATA_ROOT, SeedDataError, load_specs
    ...
    def test_missing_required_key_raises(self):
        with tempfile.TemporaryDirectory() as root:
            ...
            with open(os.path.join(mod, "bad.json"), "w", encoding="utf-8") as fh:
                json.dump({"doctype": "Email Template", "records": []}, fh)
