...
Size note: 65 test lines against 15 in the subject (4.3x), for 8 distinct behaviours. The ratio is arithmetic on a small subject, not overtesting — each test names a different one.
"""
