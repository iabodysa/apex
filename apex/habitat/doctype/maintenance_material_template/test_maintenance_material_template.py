...
Size note: 105 test lines against 36 in the subject (2.9x), for 2 distinct behaviours. The ratio is arithmetic on a small subject, not overtesting: each test names a different behaviour.
"""
...
class TestMaintenanceMaterialTemplateLoad(FrappeTestCase):
    ...
    def test_a_refused_load_keeps_rows_written_earlier_in_the_same_request(self):
        ...
        self.assertIn(
            "Resolution Notes are required", str(caught.exception),
