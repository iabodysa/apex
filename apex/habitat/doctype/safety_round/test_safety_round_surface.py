...
# Rooted at the INSTALLED package. Walking up from this file lands in .claude/tests/, where
# the glob matches no workspace at all — so workspace_links() returned an empty list and
# every assertion below passed over nothing.
