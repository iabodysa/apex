...
from apex.setup import create_role_profiles, create_roles
...
# Mirrors habitat.permissions.PRIVILEGED_ROLES. Resident Supervisor is deliberately
# NOT in it: the role is building-scoped, and maintenance intake is owner-scoped, so a
# supervisor sees the tickets they raised or were assigned, not every ticket on site.
PRIVILEGED_ROLES = [
