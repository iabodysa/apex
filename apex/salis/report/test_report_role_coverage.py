...
KNOWN_REPORT_ROLE_GAPS = {
    ...
    # Finance Manager was frozen here while `report` was an open owner decision. It was
    # ruled on 2026-07-31 and GRANTED, so the pair is closed rather than frozen; the
    # decision and its cost live beside the DocPerm rows, in
    # habitat/doctype/custody_damage_assessment/test_finance_manager_field_overlay.py.
