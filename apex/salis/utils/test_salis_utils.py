...
The one case that needs a real row to lock hangs its quota off the shipped vehicle
fixture and takes the quota away again.
"""
...
class TestSalisUtils(FrappeTestCase):
    ...
    def test_lock_fuel_quota_issues_for_update(self):
        ...
        vehicle = frappe.db.get_value("Salis Vehicle", {"plate_number": PLATE}, "name")
