...
// covers /masar; *.min.js under www/ ships as static source (no Jinja). Shell +
// portal data API are NETWORK-FIRST (latest build/data win online, cache only when
// unreachable, bounded timeout); fonts are cache-first; stale caches drop on activate. BUILD
