...
// Masar PWA service worker, served at ROOT (/driver-sw.min.js) so its scope
// covers /driver. Shell is NETWORK-FIRST; licensed font assets are cache-first; stale owned caches
...
// licensed Thmanyah stylesheet and fonts. The HTML is cached under /driver (no query string) so
