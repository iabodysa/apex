...
PERMISSION_RECHECK_ALLOWLIST = [
    ...
    (
        "salis/api/driver_portal/clearance.py",
        "get_my_clearance_certificate",
        "Driver portal certificate action. The driver is resolved from the personal "
        "credential and the endpoint selects only that driver's submitted, Cleared "
        "Driver Clearance before maintaining its finite Document Share Key. "
