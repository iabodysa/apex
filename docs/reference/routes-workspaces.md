...
| `/housing` | Accommodation operators | Guest redirect, then `PORTAL_ROLES`: Accommodation Manager, Procurement Supervisor, Resident Supervisor, Safety Officer, System Manager. | `apex/www/housing.py` · `housing_portal` |
...
| `/safety` | Safety supervisors | Guest redirect, then `PORTAL_ROLES`: Accommodation Manager, Procurement Supervisor, Resident Supervisor, Safety Officer, System Manager. | `apex/www/safety.py` · `safety_portal` |
