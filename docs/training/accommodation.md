...
|---------|----------------------|---------------------|------------------------------|-----------------|
| Site | Read, Write, Create | — | — | — |
| Building | Read, Write, Create | Read | — | — |
| Room | Read, Write, Create | Read | — | — |
| Bed | Read, Write, Create | Read | — | — |
| Facility Asset | Read, Write, Create | Read | — | — |
| **Housing Assignment** *(submittable)* | Read, Write, Create, Submit, Cancel | Read, Write, Create, Submit | — | — |
| **Housing Checkout** *(submittable)* | Read, Write, Create, Submit, Cancel | Read, Write, Create, Submit | — | — |
...
> **Triage-field split:** the three housing roles hold Read/Write on the `permlevel 1` triage fields of Resident Request, separating resident-entered data from internal triage handling.
...
- **Roles:** Accommodation Manager maintains; supervisors read Building, Room and
  Bed to pick a bed. Site itself is Manager-only.
