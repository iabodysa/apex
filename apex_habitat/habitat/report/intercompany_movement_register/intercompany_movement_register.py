...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": frappe._("From Building"), "fieldname": "from_building", "fieldtype": "Link", "options": "Building", "width": 150},
        {"label": frappe._("From Company"), "fieldname": "from_company", "fieldtype": "Link", "options": "Company", "width": 140},
        {"label": frappe._("To Building"), "fieldname": "to_building", "fieldtype": "Link", "options": "Building", "width": 150},
