...
# apex_habitat.salis.api.driver_portal.<endpoint> resolving here after the
# domain split, so every frontend/test/notification caller is unaffected.
# ---------------------------------------------------------------------------
from apex_habitat.salis.api.driver_portal.profile import (  # noqa: E402
    get_driver_context,
    get_driver_profile,
    get_my_vehicle,
)
from apex_habitat.salis.api.driver_portal.trips import (  # noqa: E402
    my_trips_today,
    my_trips_recent,
    my_worker_route_today,
    my_trip_route,
)
from apex_habitat.salis.api.driver_portal.attendance import (  # noqa: E402
    get_today_attendance,
    my_attendance,
    driver_check_in,
    driver_check_out,
)
from apex_habitat.salis.api.driver_portal.fuel import (  # noqa: E402
    submit_fuel_request,
    my_fuel_quota,
    my_fuel_requests,
)
from apex_habitat.salis.api.driver_portal.support import (  # noqa: E402
    my_support_tickets,
...
from apex_habitat.salis.api.driver_portal.boarding import (  # noqa: E402
    manual_boarding_sheet,
    manual_board_workers,
)
from apex_habitat.salis.api.driver_portal.execution import (  # noqa: E402
    start_my_trip,
    complete_my_trip,
    push_driver_position,
    mark_stop_progress,
)
from apex_habitat.salis.api.driver_portal.clearance import (  # noqa: E402
    my_clearance,
)
from apex_habitat.salis.api.driver_portal.notifications import (  # noqa: E402
    get_my_notifications,
    get_push_config,
    delete_push_subscription,
)
from apex_habitat.salis.api.driver_portal.home import (  # noqa: E402
    get_my_today,
)
