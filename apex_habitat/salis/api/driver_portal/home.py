...
"""Salis Driver Portal — home endpoints (split from the driver_portal god module in P-180). Kernel helpers are imported from the package so the canonical dotted path apex_habitat.salis.api.driver_portal.<fn> is unchanged."""
