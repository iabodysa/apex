...
_CHARTS = [
    ...
    {"name": "Support Tickets by Status", "document_type": "Issue", "type": "Donut",
     "chart_type": "Group By", "group_by_based_on": "status"},
...
_CARDS = [
    ...
    {"name": "Drivers Absent Today", "document_type": "Driver Attendance",
     "filters": [["Driver Attendance", "status", "=", "Absent"],
                 ["Driver Attendance", "attendance_date", "Timespan", "today"],
                 ["Driver Attendance", "docstatus", "=", 1]]},
    {"name": "Open Support Tickets", "document_type": "Issue",
     "filters": [["Issue", "status", "in", ["Open", "Replied", "On Hold"]]]},
    {"name": "Urgent Support Tickets", "document_type": "Issue",
     "filters": [["Issue", "priority", "=", "Urgent"],
                 ["Issue", "status", "!=", "Closed"]]},
