...
// (set by www/safety.py). createResource handles the round endpoints; this
// helper is used for the building picker's standard get_list call, where a
// plain fetch is simpler than a resource.
