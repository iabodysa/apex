...
scheduler_events = {
    "daily": [
        "apex_habitat.habitat.tasks.cost.daily_accommodation_cost_allocation",
        "apex_habitat.habitat.tasks.maintenance.daily_building_license_expiry_check",
        "apex_habitat.habitat.tasks.maintenance.open_maintenance_escalation",
        "apex_habitat.habitat.tasks.residency.lease_expiry_watchlist",
        "apex_habitat.habitat.tasks.residency.temporary_stay_checkout_watchlist",
        "apex_habitat.habitat.tasks.residency.idle_resident_aging",
        "apex_habitat.habitat.tasks.custody.consumable_custody_expiry_watch",
        "apex_habitat.habitat.tasks.scheduled_tasks.daily_scheduled_task_instance_generator",
        "apex_habitat.habitat.tasks.occupancy.daily_occupancy_snapshot",
        # [#t554-clean] auto-create today's draft Cleaning Log per active building
        "apex_habitat.habitat.tasks.cleaning.daily_cleaning_log_generator",
        # [#t554-clean-sup] supervisor-targeted variant: only buildings with a supervisor
        "apex_habitat.habitat.tasks.cleaning.auto_create_cleaning_logs",
        # [#wave3-safety]
        "apex_habitat.habitat.tasks.safety.daily_safety_task_compliance_scan",
        "apex_habitat.habitat.tasks.safety.audit_remediation_deadline_watch",
        # [#8d555o]
        "apex_habitat.habitat.temporary_worker_engine.link_temporary_workers",
        # [#3mjdri]
        "apex_habitat.salis.tasks.driver.driver_license_expiry_watch",
        "apex_habitat.salis.tasks.vehicle.idle_vehicle_watch",
        "apex_habitat.salis.tasks.fuel.unreverted_topup_watch",
        "apex_habitat.salis.tasks.fuel.overdue_fuel_request_watch",
        "apex_habitat.salis.tasks.attendance.missing_attendance_watch",
        "apex_habitat.salis.tasks.vehicle.vehicle_compliance_expiry_watch",
        "apex_habitat.salis.tasks.workshop.workshop_overstay_watch",
        "apex_habitat.salis.tasks.alerts.reconcile_operations_alerts",
    ...
    "weekly": [
        "apex_habitat.habitat.tasks.occupancy.weekly_occupancy_sync",
        "apex_habitat.habitat.tasks.custody.weekly_custody_digest",
        # [#wave3-safety]
        "apex_habitat.habitat.tasks.safety.weekly_safety_coverage_gate",
        "apex_habitat.salis.tasks.vehicle.vehicle_utilization_summary",
...
permission_query_conditions = {
    ...
    "Facility Asset Movement": "apex_habitat.habitat.permissions.facility_asset_movement_query",
    "Custody Acknowledgment": "apex_habitat.habitat.permissions.custody_acknowledgment_query",
    "Custody Handover": "apex_habitat.habitat.permissions.custody_handover_query",
    "Facility Asset Delivery": "apex_habitat.habitat.permissions.facility_asset_delivery_query",
    "Facility Asset": "apex_habitat.habitat.permissions.facility_asset_query",
    ...
    "Vehicle Damage Write-Off": "apex_habitat.salis.permissions.vehicle_damage_write_off_query",
    "Vehicle Incident": "apex_habitat.salis.permissions.vehicle_incident_query",
...
has_permission = {
    ...
    "Facility Asset": "apex_habitat.habitat.permissions.building_scoped_has_permission",
    "Housing Inventory": "apex_habitat.habitat.permissions.building_scoped_has_permission",
    "Building License": "apex_habitat.habitat.permissions.building_scoped_has_permission",
    "Maintenance Work Order": "apex_habitat.habitat.permissions.building_scoped_has_permission",
    "Accommodation Material Transfer": "apex_habitat.habitat.permissions.dual_building_scoped_has_permission",
    ...
    "Vehicle Damage Write-Off": "apex_habitat.salis.permissions.vehicle_damage_write_off_has_permission",
    "Vehicle Incident": "apex_habitat.salis.permissions.vehicle_incident_has_permission",
