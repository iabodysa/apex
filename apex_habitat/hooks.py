...
permission_query_conditions = {
    ...
    "Accommodation Custody Handover": "apex_habitat.habitat.permissions.accommodation_custody_handover_query",
...
has_permission = {
    ...
    "Accommodation Custody Handover": "apex_habitat.habitat.permissions.dual_building_scoped_has_permission",
