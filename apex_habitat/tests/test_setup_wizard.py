...
class TestApexSetupWizard(FrappeTestCase):
    def test_payment_method_applies_and_toggles_stay_safe(self):
        # The operator picks a payment method and ticks "deduct housing allowance",
        # but no authorizer is configured yet → the wizard saves the payment method
        # and keeps the deduction OFF (safe), without failing.
