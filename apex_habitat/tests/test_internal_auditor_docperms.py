...
# Maps doctype_folder -> expected pre-existing writer roles (regression guard)
_TARGET_DOCTYPES = {
...
class TestInternalAuditorDocPerms(unittest.TestCase):
    ...
    def _check_doctype(self, folder: str, pre_existing_roles: list):
        ...
        # 4. Pre-existing writer roles still present (regression)
    ...
    def test_cleaning_log_auditor_row_coexists_with_cleaning_supervisor(self):
        ...
        # Cleaning Supervisor row must still exist (T6 ownership preserved)
