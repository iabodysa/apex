...
const messages = {
  en: {
    ...
    manifest: {
      ...
      hint: "Track who's aboard. Confirm or reject each worker's claim, then depart.",
      ...
      confirmed: "Worker confirmed aboard",
      rejected: "Claim rejected",
      waitRequest: "{name} asks to wait ({n} of {max})",
      newClaim: "{name} says they're aboard — confirm or reject",
      close: "Close",
  ...
  ar: {
    ...
    manifest: {
      open: "الصعود",
      title: "قائمة الصعود",
      hint: "تابع من على المتن. أكّد أو ارفض مطالبة كل عامل، ثم غادر.",
      ...
      confirmed: "تم تأكيد صعود العامل",
      rejected: "تم رفض المطالبة",
      waitRequest: "{name} يطلب الانتظار ({n} من {max})",
      newClaim: "{name} يقول إنه على المتن — أكّد أو ارفض",
      close: "إغلاق",
      remaining: "{n} متبقٍ",
    },
    fuel: {
